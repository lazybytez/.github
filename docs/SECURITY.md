...
This policy applies to all repositories under the [lazybytez][org] GitHub organization.
...
Send a report to [security@lazybytez.de][security-email] instead. Please include:
...
[org]: https://github.com/lazybytez
[security-email]: mailto:security@lazybytez.de
